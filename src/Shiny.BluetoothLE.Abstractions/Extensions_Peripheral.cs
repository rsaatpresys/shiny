...
public static class BlePeripheralExtensions
{
    ...
    public static bool ConnectIf(this IPeripheral peripheral)
    {
    ...
    /// <returns></returns>
    public static IObservable<IPeripheral> WithConnectIf(this IPeripheral peripheral) => Observable.Create<IPeripheral>(ob =>
    {
